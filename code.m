function [] = code(num_of_genes,netnum,disc,disclevel,variant)
...
if variant==1
[all_edges] = unwt_edge_prob(prod_con_op_sign,decay_con_op_sign,sus_decay_con_op_sign,sus_prod_con_op_sign,num_of_genes,produce_count,decay_count,sus_decay_count,sus_prod_count);
elseif variant==2
...
save 'final_edges.mat' final_edges
